...
import { calculateVerticalTankVolume } from '@/lib/calculations/hydraulic';
...
export function VerticalTankCalculator() {
  ...
  const handleCalculate = useCallback(() => {
    ...
    const result = calculateVerticalTankVolume(radius, height);
